...
function HoverFlechas1() {
    document.getElementById('hover-left-1').style.visibility = 'visible';
    document.getElementById('hover-right-1').style.visibility = 'visible';
}

function MoveMouse1() {
    document.getElementById('hover-left-1').style.visibility = 'hidden';
    document.getElementById('hover-right-1').style.visibility = 'hidden';
}
...
function FillColor1() {
    if (localStorage.getItem('theme') == 'true') {
        document.getElementById('icon-organim-1').style.fill = '#F9F9F9';
        document.getElementById('word-list-1').style.color = '#F9F9F9';
    }
}

function RemoveColor1() {
    if (localStorage.getItem('theme') == 'true') {
        document.getElementById('icon-organim-1').style.fill = '#141927';
        document.getElementById('word-list-1').style.color = '#141927'
    }
}
